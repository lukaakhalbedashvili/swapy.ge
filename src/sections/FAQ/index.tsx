...
const FAQ = () => {
  const faqs = [
    ...
    {
      question: "რამდენ ხანში აისახება პლუს ქულები ანგარიშზე?",
      answer: "ტრანზაქციის დასრულების შემდეგ, 10 წუთის განმავლობაში.",
    },
    {
    ...
    {
      question: "პლუს ქულები რამდენი ლარია",
      answer:
        "საქართველოს ბანკის სტრანდარტული კურსი 400 ქულა - 1 ლარი. სვაპიზე კი 400 ქულა 1.1 ლარია",
    },
  ];
