...
const FAQ = () => {
  const faqs = [
    ...
    // },
    {
      ...
      answer:
        "ტრანზაქციის წარმატებით დასრულების შემთხვევაში თანხა დაგერიცხებათ თქვენ პირად ნომერზე არსებულ რომელიმე ანგარიშზე. თუ გსურთ თანხა კონკრეტულ ანგარიშზე დაირიცხოს, მიუთითეთ კომენტარის სახით PLUS ქულების გადმორიცხვისას",
    },
  ];
