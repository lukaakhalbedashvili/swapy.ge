  ...
  return (
    ...
    >
      ...
      <div className="bg-body rounded-lg p-2 lg:p-10 text-gray-400 text-center w-full">
        ...
        <h2 className="text-white font-semibold mb-10 mt-20">
          როგორ ვიყიდოთ და გამოვიყენოთ პლუს ქულები სვაპიზე?
        </h2>
        <ul className="list-disc pl-6 text-center">
          <li className="mb-3">
            პლუს ქულების სვაპიზე ყიდვა უმარტივესი პროცესია. რომლის ინსტრუქცია
            პირველ სექციაში შეგიძლიათ იხილოთ.
          </li>
          <li className="mb-3">
            ნაყიდი პლუს ქულების გამოყენება შეგიძლიათ სხვადასხვა ნივთის შესაძენად
            ფასდაკლებებით.
          </li>
          <li className="mb-3">
            L პაკეტი: ასევე გასათვალისწინებელია რომ თუ გსურთ ხელსაყრელი
            ფასდაკლებით ნივთების ყიდვა, L პაკეტის გააქტიურების შემთხვევაში,
            არსებულ ფასდაკლებას + 10% ფასდაკლება დაემატება. მაქსიმუს 50%
          </li>
        </ul>
